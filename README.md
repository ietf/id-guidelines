...
"boilerplate" text in each Internet-Draft. This text is managed by the IETF
Trust, see [TLP Section
6](https://trustee.ietf.org/documents/trust-legal-provisions/).
...
Authors of IETF stream documents must generally include a boilerplate variant
that grants the IETF the rights to produce derivative works. There are very rare
...
standard Copyright Notice and Disclaimer exactly as shown in [TLP Section
6](https://trustee.ietf.org/documents/trust-legal-provisions/).
...
1. The first choice is used if the contributor intends for the I-D to be
published as an RFC:
...
2. The second choice is used when the contributor does not intend for the I-D
